 ...
 <?php 
   ...
   ?>
    ...
    <div class="row top" style="width: 100%; ">
      <div style="float: left; width: 50%; text-align: center; " >   <p style="font-size: 13px; margin-bottom: 3px; font-family: times new roman;  "> TRUNG TÂM QUY HOẠCH VÀ ĐIỀU TRA TÀI NGUYÊN NƯỚC QUỐC GIA </p>    <p style="font-size: 14px; font-weight: bold; margin-bottom: 3px; font-family: times new roman;  ">HỘI ĐỒNG NGHIỆM THU  </p>
        <p> Số: ..................................</p>
    ...
    <p style="margin-bottom:10px; margin-top: 20px; font-weight: bold; text-align: center; color: blue; font-size: 14px;">( 6 THÁNG CUỐI NĂM)
    	...
    	<tbody>
          ...
          <td>{{$phuluckhoiluongtt->ntql6t}}</td>
    			...
    			<td>{{$phuluckhoiluongtt->ntql12t}}</td>
    			 <td>@if($phuluckhoiluongtt->ntql12t !=null && $phuluckhoiluongtt->khoiluong !=null && $phuluckhoiluongtt->khoiluong !=0) {{ round((($phuluckhoiluongtt->ntql12t + $phuluckhoiluongtt->ntql6t) /$phuluckhoiluongtt->khoiluong)*100)}} % @endif</td>
    		</tr>
    		@endforeach

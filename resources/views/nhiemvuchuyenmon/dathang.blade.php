...
<div class="container" style="background-color: white; padding: 20px 20px 20px 30px; width: 100%;">
	    ...
	    <div class="modal-body">
        	<form action="{{route('dathangpost',[$id_nv])}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="usr">Năm thưc hiện<span style="color: red;">(*)</span></label>
                  <input type="number" class="form-control" name="namthuchien"  required="required" />
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label>Tên danh mục dịch vụ sự nghiệp công</label>
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label>Phụ lục khối lượng (Tải file mẫu tại đây <a href="public/anh/khoiluongphuluc.xlsx"><i class="fa fa-cloud-download" aria-hidden="true"></i></a>) </label>

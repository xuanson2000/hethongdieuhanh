 ...
 <!--          
           <li class="treeview">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('nhiemvutt')}}"><i class="fa fa-caret-right" aria-hidden="true"></i>Nhiệm vụ chuyên môn</a></li>
        <!--         <li><a href="{{route('nguoidung')}}"><i class="fa fa-caret-right" aria-hidden="true"></i>Đề tài NCKH</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('nhiemvuchuyenmonttnghiemthu')}}"><i class="fa fa-caret-right" aria-hidden="true"></i>Nhiệm vụ chuyên môn </a></li>
          <!--       <li><a href="{{route('nguoidung')}}"><i class="fa fa-caret-right" aria-hidden="true"></i>Đề tài NCKH</a></li>
                <li><a href="{{route('nguoidung')}}"><i class="fa fa-caret-right" aria-hidden="true"></i>Dư án đầu tư</a></li> -->
